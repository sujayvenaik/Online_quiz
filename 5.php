...
$answer=mysql_query("SELECT q5 FROM `applicants` WHERE email='".$_SESSION['email']."'");
...
<h3>Question 5: This is a simple dynamic programming problem. The key is figure out the recurrence relation in the given problem.
<br>At first glance, it appears that the robber could just rob every other house – in which case, we ask whether he should start with the first house or the second house; this could maximize the number of houses he robs. However, it is possible that neither of these possibilities maximize the amount of money he’d steal (e.g. house 1 and 4 have a million dollars each, and the rest have no money).
</h3>
<form class="" action="q5.php" method="post">
  <div class="form-group">
    <label for="txtarea1" class="col-sm-2 control-label"><h3>Answer</h3></label>
    <div class="col-sm-8"><textarea name="txtarea5" id="txtarea5" cols="50" rows="100000000" class="form-control1" style="height:300px"><?php echo $ans2[0]; ?></textarea></div>
  </div>
