...
<h3>Question 2: -Given an array of n integers where n>1, return an array of same size an input array where at every index of the output array should contain the product of all elements in the array except the element at the given index.<br>
Example:<br>
arr[] = {10, 4, 1, 6, 2}<br>
prod[] = {48,120,480,80,240}<br>
</h3>
<form class="" action="q2.php" method="post">
  <div class="form-group">
    <label for="txtarea1" class="col-sm-2 control-label"><h3>Answer</h3></label>
    <div class="col-sm-8"><textarea name="txtarea2" id="txtarea2" cols="50" rows="1000000" class="form-control1" style="height:300px"><?php echo $ans2[0]; ?></textarea></div>
  </div>
