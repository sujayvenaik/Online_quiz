...
<h3>Question 9: Given an array, reverse every sub-array formed by consecutive k elements.<br>
Input: <br>
arr = [1, 2, 3, 4, 5, 6, 7, 8, 9]<br>
k = 3<br>
Output:  <br>
[3, 2, 1, 6, 5, 4, 9, 8, 7]</h3>
<form class="" action="q9.php" method="post">
  <div class="form-group">
    <label for="txtarea1" class="col-sm-2 control-label"><h3>Answer</h3></label>
    <div class="col-sm-8"><textarea name="txtarea9" id="txtarea9" cols="50" rows="100000000" class="form-control1" style="height:300px"><?php echo $ans2[0]; ?></textarea></div>
  </div>
