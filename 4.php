...
<h3>Question 4: Write a program that takes an integer and displays the English name of that value. <br>
...
<form class="" action="q4.php" method="post">
  <div class="form-group">
    ...
    <div class="col-sm-8"><textarea name="txtarea4" id="txtarea4" cols="50" rows="10000000" class="form-control1" style="height:300px"><?php echo $ans2[0]; ?></textarea></div>
  </div>
