...
<h4>Question 10: Initialise a linked list from 1-10 and reverse the linked list using self-refrential structure.</h4>
<form class="" action="q10.php" method="post">
  <div class="form-group">
    <label for="txtarea1" class="col-sm-2 control-label"><h3>Answer</h3></label>
    <div class="col-sm-8"><textarea name="txtarea5" id="txtarea5" cols="50" rows="10000000" class="form-control1" style="height:300px"><?php echo $ans2[0]; ?></textarea></div>
  </div>
