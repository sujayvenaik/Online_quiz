...
$answer=mysql_query("SELECT q6 FROM `applicants` WHERE email='".$_SESSION['email']."'");
...
<h3>Question 6: Write a program that, when run, will print out its source code. This source code, in turn, should compile and print out itself.</h3>
<form class="" action="q6.php" method="post">
  <div class="form-group">
    <label for="txtarea1" class="col-sm-2 control-label"><h3>Answer</h3></label>
    <div class="col-sm-8"><textarea name="txtarea6" id="txtarea6" cols="50" rows="10000000" class="form-control1" style="height:300px"><?php echo $ans2[0]; ?></textarea></div>
  </div>
