...
$answer=mysql_query("SELECT q8 FROM `applicants` WHERE email='".$_SESSION['email']."'");
...
<h3>Question 8: Test whether a no. is power of 2 or not.</h3>
<form class="" action="q8.php" method="post">
  <div class="form-group">
    <label for="txtarea1" class="col-sm-2 control-label"><h3>Answer</h3></label>
    <div class="col-sm-8"><textarea name="txtarea8" id="txtarea8" cols="50" rows="100000000" class="form-control1" style="height:300px"><?php echo $ans2[0]; ?></textarea></div>
  </div>
