...
<h3>Question 1: Set every cell in a matrix to 0 if that row or column contains a 0.<br>
...
<form class="" action="q1.php" method="post">
  <div class="form-group">
    ...
    <div class="col-sm-8"><textarea name="txtarea1" id="txtarea1" cols="50" rows="100000" class="form-control1" style="height:300px" placeholder="text"><?php echo $ans2[0]; ?></textarea></div>
  </div>
